...
Funcionalidade: Receber pedido de locação
    ...
    Cenario: Receber pedido
        ...
        Dado que meu perfil de anunciante é "paula@anunciante.com" e "pwd123"
        ...
        Quando "quesia@locataria.com" e "pwd123" solicita a locação desse equipo
        Então devo ver a seguinte mensagem:
            """
            quesia@locataria.com deseja alugar o equipamento: Trompete em: DATA_ATUAL
            """
